...
default_pp = URI.open('https://web-hunt-seeds.s3.amazonaws.com/user-2.png')
default_hp = URI.open('https://web-hunt-seeds.s3.amazonaws.com/header.png')

default_pp1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/user-2.png')
default_hp1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/header.png')

default_pp2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/user-2.png')
default_hp2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/header.png')

default_pp3 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/user-2.png')
default_hp3 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/header.png')

default_pp4 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/user-2.png')
default_hp4 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/header.png')

default_pp5 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/user-2.png')
default_hp5 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/header.png')
...
slack_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/slack-2.png')
vs_code_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/vscode-logo.jpg')
rails_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/rails.png')
redux_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/redux.png')
react_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/react.png')
so_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/so.png')
atom_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/atom.png')
sublime_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/sublime.jpg')
mongodb_logo = URI.open('https://web-hunt-seeds.s3.amazonaws.com/mongodb_logo.jpg')

vs_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/vs-ss2.png')
st_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/st-ss1.png')
st_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/st-ss2.png')
at_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/at-ss2.png')
at_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/at-ss1.png')
so_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/so-ss2.png')
so_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/so-ss1.png')
ra_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/ra-ss1.png')
ra_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/ra-ss2.png')
vs_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/vs-ss1.png')
sl_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/sl-ss2.png')
sl_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/sl-ss1.png')
mo_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/mo-ss2.png')
mo_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/mo-ss1.png')
re_ss2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/re-ss2.png')
re_ss1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/re-ss1.png')
redux_ss_2 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/redux-ss-2.png')
redux_ss_1 = URI.open('https://web-hunt-seeds.s3.amazonaws.com/redux-ss-1.png')
